...
/*
    ...
    对该数组进行拆分得到：
        [4][4][4][3][3][2]
*/
int Solution_Unknown_1::Discount1(int n, int price, int budget, vector<vector<int>> discount) {
...
void Solution_Unknown_1::DiscountCore(vector<int> &discountPrice, vector<int> &saleDay, int currProduct, int budget, int remainToBuy) {
    if (ansFound) {
        return;
    }
...
int Solution_Unknown_1::Discount2(int n, int price, int budget, vector<vector<int>> discount) {
    int ans = 0;
